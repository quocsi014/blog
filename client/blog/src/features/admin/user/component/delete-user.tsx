...
export const DeleteUserForm = ({ id, setId }: DeleteCategoryFormProps) => {
      ...
      <DialogPortal>
        ...
        <DialogContent className='fixed z-50 w-[450px] top-32 left-1/2 -translate-x-1/2 p-10 rounded-xl bg-white'>
          <DialogHeader className='mb-4'>
            ...
            <DialogDescription>
              Are you sure you want to delete the user? All data of the user will also be deleted (This action can not
              undo)
            </DialogDescription>
          </DialogHeader>
